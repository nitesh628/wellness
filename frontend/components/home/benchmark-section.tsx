...
import HERO_IMAGE from '../../public/Hero.png'; // Placeholder for  image
                        ...
                        <div className="relative w-full max-w-[600px] h-[600px] rounded-3xl overflow-visible">
                            ...
                            <div className="absolute top-0 -left-4 md:-left-12 w-40 bg-white p-3 rounded-2xl shadow-xl border border-blue-100 animate-float-delayed hidden md:block">
                                <div className="relative w-full aspect-square mb-2">
                                    <Image src={Product1} alt="Longevity Pro" fill className="object-contain p-1" />
                                </div>
                                <p className="text-xs font-bold text-slate-800 leading-tight">Longevity Pro</p>
                                <div className="flex gap-0.5 mt-1"><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /></div>
                            </div>
                            ...
                            <div className="absolute top-10 -right-4 md:-right-8 w-44 bg-white p-3 rounded-2xl shadow-xl border border-blue-100 animate-float hidden md:block">
                                <div className="relative w-full aspect-square mb-2">
                                    <Image src={Product2} alt="Superfoods" fill className="object-contain p-1" />
                                </div>
                                <p className="text-xs font-bold text-slate-800 leading-tight">Complete Superfoods Blend</p>
                                <div className="flex gap-0.5 mt-1"><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /></div>
                            </div>
                            ...
                            <div className="absolute bottom-20 -left-6 md:-left-16 w-40 bg-white p-3 rounded-2xl shadow-xl border border-blue-100 animate-float hidden md:block">
                                <div className="relative w-full aspect-square mb-2">
                                    <Image src={Product1} alt="Gut Fibre" fill className="object-contain p-1" />
                                </div>
                                <p className="text-xs font-bold text-slate-800 leading-tight">Complete Gut Fibre</p>
                                <div className="flex gap-0.5 mt-1"><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /></div>
                            </div>
                            ...
                            <div className="absolute bottom-40 -right-4 md:-right-10 w-36 bg-white p-3 rounded-2xl shadow-xl border border-blue-100 animate-float-delayed hidden md:block">
                                <div className="relative w-full aspect-square mb-2">
                                    <Image src={Product4} alt="Forever Gut" fill className="object-contain p-1" />
                                </div>
                                <p className="text-xs font-bold text-slate-800 leading-tight">Forever Gut</p>
                                <div className="flex gap-0.5 mt-1"><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /><Star className="w-2 h-2 text-yellow-500 fill-current" /></div>
                            </div>
                        </div>
                    </div>
