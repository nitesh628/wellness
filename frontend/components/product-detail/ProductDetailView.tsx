                ...
                {Math.round(
                  (1 -
                    parseFloat(product.price.replace(/,/g, "")) /
                      parseFloat(product.original.replace(/,/g, ""))) *
                    100,
                )}
                %
              </span>
        ...
        <div className="max-w-4xl">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-600 leading-relaxed mb-6">
              Our {product.name} is meticulously crafted to provide the highest
              quality nutraceutical support. Each batch undergoes rigorous
